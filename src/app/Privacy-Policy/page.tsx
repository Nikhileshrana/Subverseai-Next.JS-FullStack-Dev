...
<br />
            ...
            <div className="space-y-4">
              ...
              <ul>
                ...
                <br />
                Please note that we do not collect any personal information about you unless you voluntarily provide it to us. To this end, we will use your information for, but not limited to, communicating with you in relation to services and/or products you have requested from us, and sending you newsletters, marketing or promotional materials and other information that may be of interest to you. You may opt out of receiving any, or all, of these communications from us by following the unsubscribe link
              </ul>          
              </p>
            </div>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-[#334155]">Usage Data</h2>
              <p className="text-[#64748B] dark:text-[#94A3B8]">
              ...
              <br />
              The information that may be included in this usage data when you use a mobile device to access the service includes the kind of mobile device you use, its unique ID, its IP address, its operating system, the kind of mobile Internet browser you use, and other diagnostic data.
              <br />         
              </p>
            </div>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-[#334155]">Location Data</h2>
              <p className="text-[#64748B] dark:text-[#94A3B8]">
              If you grant us permission to do so, we may use and keep track of your location data ("Location Data"). We utilize your information to offer features, enhance, and personalize our service.
                            <br />
                            Whenever you use our Service, you have the option to enable or disable location services using your device's settings.
              <br />
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-[#334155]">Tracking & Cookies Data</h2>
              <p className="text-[#64748B] dark:text-[#94A3B8]">
...
Retell AI Inc. will take all reasonably required actions to guarantee that your data is handled securely and in compliance with this privacy policy. Your personal data will not be transferred to another organization or nation unless sufficient safeguards, such as those pertaining to the security of your data and other personal information, are in place.
              ...
              <br />
              **Your Data Protection Rights Under various Laws.**
...
Please note that we may ask you to verify your identity before responding to such requests as we may not be able to provide Service without some necessary data.

You have the right to complain to a Data Protection Authority about our collection and use of your Personal Data. For more information, please contact your local data protection authority in the European Economic Area (EEA).

1. **California Privacy Protection Act (CalOPPA)**
...
- **Google Analytics**: Google Analytics is a web analytics service offered by Google that tracks and reports website traffic. For more information on the privacy practices of Google, please visit the Google Privacy & Terms web page: https://policies.google.com/privacy?hl=en
- **Cloudflare Analytics**: Cloudflare analytics is a web analytics service operated by Cloudflare Inc. Read the Privacy Policy here: https://www.cloudflare.com/privacypolicy/
- **Segment.io**: Segment.io is a web traffic analysis tool. Read the Privacy Policy for Segment.io here: https://segment.com/legal/privacy/.
- **Mixpanel**: Mixpanel is provided by Mixpanel Inc. You can prevent Mixpanel from using your information for analytics purposes by opting-out. To opt-out of Mixpanel service, please visit this page: https://mixpanel.com/optout/
- **PostHog**: For more information about PostHog, please visit their Privacy Policy: https://posthog.com/privacy
1. **CI/CD tools**
- **GitHub**: GitHub is provided by GitHub, Inc. GitHub is a development platform to host and review code, manage projects, and build software. For more information on what data GitHub collects and how the protection of the data is ensured, please visit GitHub Privacy Policy page: https://help.github.com/en/articles/github-privacy-statement.
