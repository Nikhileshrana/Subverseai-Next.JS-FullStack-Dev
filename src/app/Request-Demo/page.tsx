        ...
        <div className='w-full h-full p-5'>
          <div className="max-w-md w-full mx-auto space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl font-bold text-[#334155]">Explore SubVerse</h1>
              <p className="text-[#64748B] dark:text-[#94A3B8]">Ready to unlock the power of AI with our comprehensive solutions? Discover how SubVerse helps your business elevate performance. Fill out the form below to request a personalized demo!</p>
            </div>
            <form className="pace-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label htmlFor="company" className="text-[#64748B] dark:text-[#94A3B8] text-sm font-medium">
                    Company
                  </label>
                  <input
                    type="text"
                ...
                <div className="space-y-2">
                  <label htmlFor="phone" className="text-[#64748B] dark:text-[#94A3B8] text-sm font-medium">
                    Phone
                  </label>
                  <input
                    type="text"
